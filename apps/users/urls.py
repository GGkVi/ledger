...
from .views import SignUpAPIView, LogoutAPIView, UserProfileAPIView, UserProfileUpdateAPIView, UserProfileDeleteAPIView
...
urlpatterns = [
    ...
    path("profile/update/", UserProfileUpdateAPIView.as_view(), name="profile-update"), # 유저 수정
    path("profile/delete/", UserProfileDeleteAPIView.as_view(), name="profile-delete"), # 유저 삭제
    # jwt views
