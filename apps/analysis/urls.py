...
from .views import AnalysisView, AnalysisDetailView, AnalysisImageDownloadView
...
urlpatterns = [
    ...
    # 이미지 다운로드
    path('<int:pk>/download/', AnalysisImageDownloadView.as_view(), name='analysis-download'),
]
